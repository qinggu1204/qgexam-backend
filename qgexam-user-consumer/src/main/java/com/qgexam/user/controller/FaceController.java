...
public class FaceController extends BaseController {
    ...
    public ResponseResult searchFace(String file) throws Exception {
        ...
        if (CollectionUtil.isNotEmpty(userFaceInfoList)) {
            ...
            FaceSearchResVO faceSearchResDto = new FaceSearchResVO();
            ...
            if (CollectionUtil.isNotEmpty(processInfoList)) {
                //人脸检测
                List<FaceInfo> faceInfoList = faceEngineService.detectFaces(BeanCopyUtils.copyBean(imageInfo, ImageInfo2.class));
